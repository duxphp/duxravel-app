 ...
 * @method static \Duxravel\Core\UI\Widget\Descriptions descriptions($data, callable $callback = NULL)
 ...
 * @method static \Duxravel\Core\UI\Widget\Lists lists($data, callable $callback = NULL)
 * @method static \Duxravel\Core\UI\Widget\Menu menu(string $name, string $type = 'default', callable $callback = NULL)
 * @method static \Duxravel\Core\UI\Widget\Progress progress($value, callable $callback = NULL)
