<div class="m-5 ">
    ...
    <div class="bg-white rounded px-4 {{!$dialog ? 'shadow' : ''}}">
                    ...
                    <div x-cloak x-data="{collapse: {{$filterStatus ? 'true' : 'false'}} }">
                        ...
                        @if ($quick)
                            <div class="flex flex-wrap flex-col lg:flex-row gap-4 pt-4">
                                ...
                                @if ($filter)
                                    <div>
                                        <button type="button" class="btn-outline-blue  w-full flex justify-center"
                                                data-bs-toggle="collapse" data-bs-target="#filter-sub"
                                                aria-expanded="false" aria-label="筛选" @click="collapse = !collapse">筛选
                                        </button>
                                    </div>
                                @endif
                                <div>
        ...
        <div data-js="table-bind" data-ajax="{{$ajax}}" data-tree="{{$tree}}" data-sortable="{{$sortable}}" class="py-4" id="table">
            @if($toolsHtml)
