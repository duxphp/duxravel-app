...
class CreateFormTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('form', function (Blueprint $table) {
            $table->boolean('audit')->default(0)->comment('审核状态')->after('search');
            $table->boolean('submit')->default(0)->comment('外部提交')->after('audit');
            $table->integer('interval')->default(10)->comment('提交间隔')->comment('search');
